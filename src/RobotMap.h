...
public:
	...
	static DoubleSolenoid* boxGrabberSolenoid;
	static Compressor* boxGrabberCompressor;
	...
	static SpeedController* wheelSubsystemLeftController;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

	static LIDAR* lidarTest;
